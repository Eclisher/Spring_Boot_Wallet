...
import wallet.management.wallet.Model.Currency;
...
public class CurrencyRepository implements BasicRepository<Currency>{
    ...
    public Currency findCurrencyById(String currencyId) throws SQLException {
        Map<String, Pair> currencyFilter = Map.of(Query.ID_LABEL, new Pair(currencyId, true));
        List<Currency> currencies = findAll(currencyFilter);
